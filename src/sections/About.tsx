...
//import rotatingAtomAnimation from "@/assets/icons/Animation - 1745044886387.json"; // Update the path to your Lottie JSON file
        ...
        <div className="mt-20 flex flex-col gap-8">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:grid-cols-3">
            <Card className="h-[320px] md:col-span-2 lg:col-span-1 bg-gradient-to-br from-indigo-900 via-purple-900 to-black shadow-2xl border border-white/10 relative overflow-hidden">
              ...
              {/* Lottie Animation (Rotating Atom) */}
            ...
            <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2 bg-gradient-to-br from-gray-900 via-gray-950 to-black shadow-xl border border-white/10">
              ...
              <div className="relative flex-1" ref={constraintRef}>
                {hobbies.map((hobby) => (
                  <motion.div
                    key={hobby.title}
                    className="inline-flex items-center gap-2 px-6 bg-gradient-to-r from-rose-300 to-sky-400 rounded-full py-1.5 absolute cursor-pointer"
                    style={{
                      left: hobby.left,
                      top: hobby.top,
                    }}
